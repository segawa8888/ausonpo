...
const isiOS = ["iphone", "ipad", "macintosh"].some(
  (device) => ua.includes(device) && "ontouchend" in document
); //iOS(iPad含む)の判定
const isMobile = ["iphone", "ipad", "macintosh", "android"].some(
  (device) => ua.includes(device) && "ontouchend" in document
); //Mobile判定
...
document.addEventListener("componentsLoaded", () => {
  ...
  if (drawer) {
    ...
    const focusableElm = drawer.querySelectorAll(
  ...
  function disableTabOutsideDrawer() {
    const focusableElm = document.querySelectorAll(
      "a, button, input, select, textarea"
    );
...
document.addEventListener("componentsLoaded", () => {
  ...
  function toggleDrawerAccordion(button) {
    ...
    if (
      adjacentElement &&
      adjacentElement.classList.contains("js-drawer-toggle-content")
    ) {
      slideToggle(adjacentElement, button);
    }
  }
  document
    .querySelectorAll(".js-footer-toggle-btn")
    .forEach((button, index) => {
      button.addEventListener("click", function () {
        ...
        if (
          adjacentElement &&
          adjacentElement.classList.contains("js-footer-toggle-content") &&
          ww <= 520
        ) {
  ...
  document.querySelectorAll(".js-accordion-toggle-btn").forEach((button) => {
    button.addEventListener("click", function () {
      ...
      if (
        adjacentElement &&
        adjacentElement.classList.contains("js-accordion-toggle-content")
      ) {
        slideToggle(adjacentElement, this);
      }
    });
    ...
    if (isMobile) {
      ...
      const toggleAccordion = () => {
        ...
        toggleButton.innerText =
          buttonText === "詳しくはこちら" ? "閉じる" : "詳しくはこちら";
      };
...
document.addEventListener("componentsLoaded", () => {
  ...
  accordionToggles.forEach((toggleButton) => {
    ...
    accordionBody.style.transition =
      "max-height 0.5s ease-out, padding-bottom 0.5s ease-out";
...
var kaigai_price = [
  ...
  [
    [
      ...
      "1,218",
      "1,403",
      "　1日　　1,037　　1,383　　1,898",
      "　1日　　1,037　　1,218　　1,403",
    ],
    [
      "1,184",
      "1,553",
      ...
      "1,378",
      "1,588",
      "　2日　　1,184　　1,553　　2,113",
      "　2日　　1,184　　1,378　　1,588",
    ],
    [
      "1,369",
      "1,754",
      ...
      "1,574",
      "1,810",
      "　3日　　1,369　　1,754　　2,350",
      "　3日　　1,369　　1,574　　1,810",
    ],
    [
      "1,558",
      "1,968",
      ...
      "1,778",
      "2,041",
      "　4日　　1,558　　1,968　　2,611",
      "　4日　　1,558　　1,778　　2,041",
    ],
    [
      "1,950",
      "2,458",
      ...
      "2,223",
      "2,564",
      "　5日　　1,950　　2,458　　3,269",
      "　5日　　1,950　　2,223　　2,564",
    ],
    [
      "2,225",
      "2,800",
      ...
      "2,535",
      "2,926",
      "　6日　　2,225　　2,800　　3,721",
      "　6日　　2,225　　2,535　　2,926",
    ],
    [
      "2,548",
      "3,137",
      ...
      "2,867",
      "3,369",
      "　7日　　2,548　　3,137　　4,179",
      "9,039",
      ...
      "8,494",
      "9,749",
      "　24日　　7,755　　9,039　　11,384",
      "　24日　　7,755　　8,494　　9,749",
    ],
    [
      "7,755",
      "9,039",
      ...
      "8,494",
      "9,749",
      "　25日　　7,755　　9,039　　11,384",
      "　25日　　7,755　　8,494　　9,749",
    ],
    [
      "8,509",
      "9,916",
      ...
      "9,321",
      "10,655",
      "　26日　　8,509　　9,916　　12,440",
      "　26日　　8,509　　9,321　　10,655",
    ],
    [
      "8,509",
      "9,916",
      ...
      "9,321",
      "10,655",
      "　27日　　8,509　　9,916　　12,440",
      "　27日　　8,509　　9,321　　10,655",
    ],
    [
      "9,419",
      "10,945",
      ...
      "10,305",
      "11,725",
      "　28日　　9,419　　10,945　　13,645",
      "　28日　　9,419　　10,305　　11,725",
    ],
    [
      "9,419",
      "10,945",
      ...
      "10,305",
      "11,725",
      "　29日　　9,419　　10,945　　13,645",
      "　29日　　9,419　　10,305　　11,725",
    ],
    [
      "10,492",
      "12,154",
      ...
      "11,464",
      "12,983",
      "　30日　　10,492　　12,154　　15,053",
      "　30日　　10,492　　11,464　　12,983",
    ],
    [
      "10,492",
      "12,154",
      ...
      "11,464",
      "12,983",
      "　31日　　10,492　　12,154　　15,053",
      "　31日　　10,492　　11,464　　12,983",
    ],
  ],
...
document.addEventListener("componentsLoaded", () => {
  if (document.getElementById("view-all")) {
    document.getElementById("view-all").addEventListener("click", function () {
      ...
      // 表示状態が変更されているかどうかを確認
      const isHidden =
        hiddenLinks[0].style.display === "none" ||
        hiddenLinks[0].style.display === "";
      ...
      // ボタンのテキストを変更
      this.querySelector("a").textContent = isHidden
        ? "電子広告を少なく表示する"
        : "電子広告を全て見る";
    });
  }
...
const navComponents = {
  ...
  "/keiyakusya/bycle/":
    "/common_2024/component/layout/nav-keiyakusya-bycle.html",
  "/keiyakusya/pet/": "/common_2024/component/layout/nav-keiyakusya-pet.html",
  "/keiyakusya/kaigai/":
    "/common_2024/component/layout/nav-keiyakusya-kaigai.html",
  "/keiyakusya/kokunai/":
    "/common_2024/component/layout/nav-keiyakusya-kokunai.html",
  "/keiyakusya/sports/":
    "/common_2024/component/layout/nav-keiyakusya-sports.html",
...
if (!html.classList.contains("p-popup")) {
  promises.push(
    loadComponent(
      "/common_2024/component/layout/footer.html",
      ".l-main",
      "afterend"
    )
  );
  promises.push(
    loadComponent(
      "/common_2024/component/layout/header.html",
      "body",
      "afterbegin"
    ).then(() => {
      return loadComponent(
        determineNavComponent(currentUrl),
        ".l-header",
        "beforeend"
      );
    })
  ...
  promises.push(
    loadComponent(
      "/common_2024/component/layout/header_popup.html",
      "body",
      "afterbegin"
    ).then(() => {
      return loadComponent(
